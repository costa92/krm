...
KRM_APISERVER_HOST=${KRM_APISERVER_HOST:-127.0.0.1}
KRM_APISERVER_SECURE_PORT=${KRM_APISERVER_SECURE_PORT:-52443}
...
clusters:
- cluster:
    server: https://${KRM_APISERVER_HOST}:${KRM_APISERVER_SECURE_PORT}
