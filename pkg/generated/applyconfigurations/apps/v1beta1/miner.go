...
import (
	appsv1beta1 "github.com/costa92/krm/pkg/apis/apps/v1beta1"
	internal "github.com/costa92/krm/pkg/generated/applyconfigurations/internal"
	v1 "github.com/costa92/krm/pkg/generated/applyconfigurations/meta/v1"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	types "k8s.io/apimachinery/pkg/types"
	managedfields "k8s.io/apimachinery/pkg/util/managedfields"
)

// MinerApplyConfiguration represents an declarative configuration of the Miner type for use
// with apply.
...
// Miner constructs an declarative configuration of the Miner type for use with
// apply.
...
func extractMiner(miner *appsv1beta1.Miner, fieldManager string, subresource string) (*MinerApplyConfiguration, error) {
	b := &MinerApplyConfiguration{}
	err := managedfields.ExtractInto(miner, internal.Parser().Type("com.github.costa92.krm.pkg.apis.apps.v1beta1.Miner"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
