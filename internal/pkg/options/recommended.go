...
// configScheme is a runtime.Scheme for the options package.
...
// NewRecommendedOptions creates a new RecommendedOptions object.
...
func authenticationApplyTo(s *genericoptions.DelegatingAuthenticationOptions, authenticationInfo *genericapiserver.AuthenticationInfo,
	servingInfo *genericapiserver.SecureServingInfo, openAPIConfig *openapicommon.Config) error {
	if s == nil {
